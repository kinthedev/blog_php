    ...
    <div class="flex">
        ...
        <form class=" w-[35%] flex flex-col items-center py-25 px-25 space-y-8 " autocomplete="off">
            ...
            <div class="relative w-full">
                <input class="w-full outline-none  py-1" type="text" name="username"
            ...
            <button class="w-full rounded-3xl py-2 cursor-pointer active:scale-101 hover: bg-linear-to-r from-[#5468cd]
                to-[#373b8a] text-white hover:-translate-y-0.25" type="submit">Login</button>
